...
const Navbar = () => {
    ...
    <nav class="navbar">
        <ul class="navbar-nav">
          <div class="header">
            <svg width="800px" height="800px" viewBox="0 0 64 64" class="avatar">
              ...
              <g data-name="Winter Avatar">
                ...
                <path class="cls-5" d="M27.35,44.5l.7,3.13c.33,2.16,1.76,3.95,3.95,3.95s3.62-1.79,4-3.95l.7-3.13-5.41-6Z"
                  id="path22987-26-8-7" />

                <path class="cls-6" d="M18.29,28.88l-.11,1.35a13.87,13.87,0,1,0,27.64,0l-.2-2.42-8.16-11L21.38,22.12Z"
                  id="path99362-0-5" />
                ...
                <path class="cls-3" d="M33.2,22.87s5.77,6.9,12.42,4.94l-.33-4a13.17,13.17,0,0,0-5.4-9.59l-6.48,1.24Z"
                  id="path113433-6-5" />
            ...
            {/* <div class="header-dropdown"><svg width="800px" height="800px" viewBox="0 0 1024 1024"
          ...
          <hr />
          <li class="nav-item">
            <a class="nav-link-seperator"><span class="link-text-seperator">MENU</span></a>
          </li>
          <li class="nav-item">
            <NavLink to="/" className={({ isActive }) => { return isActive ? "nav-link-active" : "nav-link" }}>
              <svg width="234" height="224" viewBox="0 0 234 224" fill="none">
                ...
                <rect id="Rectangle 3" x="134" y="124" width="100" height="100" rx="30" fill="currentColor"
                  class="fa-primary" />
                <rect id="Rectangle 4" y="124" width="100" height="100" rx="30" fill="currentColor" class="fa-primary" />
              </svg>
          ...
          <li class="nav-item">
            <NavLink to="MyAssets" className={({ isActive }) => { return isActive ? "nav-link-active" : "nav-link" }}>
              ...
              <span class="link-text">My asset</span>
            </NavLink>
          </li>
          <li class="nav-item">
            ...
            <ul class="sub-nav">
              <li ><Link to="Stock" class="nav-link"><span class="link-text">Stock</span></Link></li>
              <li ><Link to="Funds" class="nav-link"><span class="link-text">Funds</span></Link></li>
              <li ><Link to="Crypto" class="nav-link"><span class="link-text">Crypto</span></Link></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link-seperator"><span class="link-text-seperator">ACCOUNT</span></a>
          </li>
          <li class="nav-item">
            <NavLink to="AcoountSettings" className={({ isActive }) => { return isActive ? "nav-link-active" : "nav-link" }}>
              <svg width="800" height="800" viewBox="0 0 800 800">
                <path class="fa-primary"
                  ...
                  fill="currentColor" />
                <path class="fa-primary" clip-rule="evenodd"
          ...
          <li class="nav-item nav-item-toggle">
            ...
            <label for="darkmode-toggle" class="darkmode-toggle-label">
              ...
              <svg class="sun" stroke="currenColor" width="800px" height="800px" viewBox="0 0 24 24">
                ...
                <path d="M16.9498 7.05026L18.364 5.63605" stroke="currenColor" stroke-width="2" stroke-linecap="round" />
                <path d="M5.63608 18.364L7.05029 16.9498" stroke="currenColor" stroke-width="2" stroke-linecap="round" />
                <path d="M19 12L21 12" stroke="currenColor" stroke-width="2" stroke-linecap="round" />
                <path d="M3 12L5 12" stroke="currenColor" stroke-width="2" stroke-linecap="round" />
                <path d="M16.9498 16.9497L18.364 18.364" stroke="currenColor" stroke-width="2" stroke-linecap="round" />
                <path d="M5.63608 5.63602L7.05029 7.05023" stroke="currenColor" stroke-width="2" stroke-linecap="round" />
              </svg>
            </label>
          </li>
        </ul>
